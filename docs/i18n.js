...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "try.h2": "Three ideas, one click each.",
      "try.subtitle": "Each card runs the full generator on the deployed app. Click and watch — every kit is fresh, every kit is yours.",
      "try.c1.quote": "\"A training plan app for busy parents.\"",
      "try.c1.desc": "App, audience: parents — domain inferred as health & wellness. ≈12 files, 47 sections, 6.8k words, < 1 second.",
    ...
    de: {
      ...
      "try.h2": "Drei Ideen, je ein Klick.",
      ...
      "try.c1.quote": "„Eine Trainingsplan-App für berufstätige Eltern.”",
      "try.c1.desc": "App, Zielgruppe: Eltern — erkannte Domain Health & Wellness. ≈12 Dateien, 47 Abschnitte, 6,8k Wörter, < 1 Sekunde.",
