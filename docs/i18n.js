...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "hero.card.idea": "A small-business website for independent cafe owners that helps them take orders online.",
      ...
      "flow.s2.pill2": "For independent cafe owners",
      ...
      "try.kicker": "Try these",
      "try.h2": "Six ideas, one click each.",
      "try.subtitle": "Each card runs the full generator on the deployed app. Click and watch — every kit is fresh, every kit is yours.",
      "try.c1.quote": "\"A training plan app for amateur runners.\"",
      "try.c1.desc": "App, audience: amateur runners — domain inferred as health & wellness. ≈12 files, 47 sections, 6.8k words, < 1 second.",
      "try.c2.quote": "\"A bookkeeping tool for solo freelancers.\"",
      "try.c2.desc": "Tool, audience: solo freelancers — domain finance. Includes auditable-defaults bullets, KYC posture notes, ADR template.",
      "try.c3.quote": "\"A marketplace for indie crafters.\"",
      "try.c3.desc": "Platform/marketplace, audience: indie crafters — domain retail & e-commerce. PCI & storefront-accessibility risks built in.",
      "try.c4.quote": "\"A volunteer scheduling platform for animal shelters.\"",
      "try.c4.desc": "Platform, audience: animal-shelter coordinators — domain non-profit & community. Donor-trust + volunteer safeguarding bullets baked in.",
      "try.c5.quote": "\"A factory floor monitoring dashboard for small manufacturers.\"",
      "try.c5.desc": "Dashboard, audience: small manufacturers — domain manufacturing. OT/IT boundary risks, NIS2/IEC 62443, OEE/MTBF posture all wired in.",
      "try.c6.quote": "\"A civic engagement app for municipal councils.\"",
      "try.c6.desc": "App, audience: municipal councils — domain government & civic. Procurement-aware, accessibility (WCAG) and FOI/transparency bullets included.",
      "try.cta": "Generate this →",
    ...
    de: {
      ...
      "hero.card.idea": "Eine kleine Website für selbstständige Café-Besitzer, die online Bestellungen entgegennimmt.",
      ...
      "flow.s2.pill2": "Für selbstständige Café-Besitzer",
      ...
      "try.kicker": "Ideen testen",
      "try.h2": "Sechs Ideen, je ein Klick.",
      "try.subtitle": "Jede Karte startet den kompletten Generator auf der App. Klicken und zuschauen — jedes Kit ist frisch, jedes Kit gehört dir.",
      "try.c1.quote": "„Eine Trainingsplan-App für Hobby-Läufer.”",
      "try.c1.desc": "App, Zielgruppe: Hobby-Läufer — erkannte Domain Health & Wellness. ≈12 Dateien, 47 Abschnitte, 6,8k Wörter, < 1 Sekunde.",
      "try.c2.quote": "„Ein Buchhaltungs-Werkzeug für Solo-Freelancer.”",
      "try.c2.desc": "Werkzeug, Zielgruppe: Solo-Freelancer — Domain Finance. Audit-Defaults, KYC-Hinweise, ADR-Template inklusive.",
      "try.c3.quote": "„Ein Marktplatz für unabhängige Kunsthandwerker.”",
      "try.c3.desc": "Plattform/Marktplatz, Zielgruppe: unabhängige Kunsthandwerker — Domain Retail & E-Commerce. PCI- und Storefront-Accessibility-Risiken eingebaut.",
      "try.c4.quote": "„Eine Plattform zur Ehrenamts-Planung für Tierheime.”",
      "try.c4.desc": "Plattform, Zielgruppe: Tierheim-Koordinatoren — Domain Non-Profit & Community. Spender-Vertrauen + Schutz Ehrenamtlicher als Bullets eingebaut.",
      "try.c5.quote": "„Ein Hallenboden-Monitoring-Dashboard für kleine Fertiger.”",
      "try.c5.desc": "Dashboard, Zielgruppe: kleine Fertiger — Domain Manufacturing. OT/IT-Grenze, NIS2/IEC 62443, OEE/MTBF-Posture verdrahtet.",
      "try.c6.quote": "„Eine Bürger-Beteiligungs-App für Gemeinderäte.”",
      "try.c6.desc": "App, Zielgruppe: Gemeinderäte — Domain Government & Civic. Beschaffungs-bewusst, Barrierefreiheit (WCAG) und IFG/Transparenz-Bullets enthalten.",
      "try.cta": "Diesen Plan erzeugen →",
