...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "how.s3.title": "Continue in Claude Code",
      "how.s3.body.html": "Push the kit to a free GitHub repo and open it in Claude Code (browser or terminal). Claude Code reads every file and walks you through Step&nbsp;1, one decision at a time.",
      "how.s3.chat-msg": "📂 GitHub repo: my-kit",
      "how.s3.chat-reply": "Reading MASTERPLAN.md…",
    ...
    de: {
      ...
      "how.s3.title": "In Claude Code weitermachen",
      "how.s3.body.html": "Pack das Kit in ein kostenloses GitHub-Repo und öffne es in Claude Code (Browser oder Terminal). Claude Code liest jede Datei und führt dich durch Schritt&nbsp;1 — eine Entscheidung nach der anderen.",
      "how.s3.chat-msg": "📂 GitHub-Repo: mein-kit",
      "how.s3.chat-reply": "Lese MASTERPLAN.md…",
