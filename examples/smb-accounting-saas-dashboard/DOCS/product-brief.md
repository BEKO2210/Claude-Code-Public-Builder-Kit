# Product brief — SaaS Dashboard for Small Business Accountants
...
A small business accountants owner / operator who is currently working in **professional services**, has tried at least one existing tool, and is willing to switch if a better one shows up.

## 2. Jobs to be done

When small business accountants hire a tool like this, they are usually trying to:
