# MASTERPLAN — SaaS Dashboard for Small Business Accountants

> Single source of truth. If anything in the repo contradicts this file, this file wins.

## 1. Vision

A focused web app that helps **small business accountants** solve a specific, painful problem in **professional services** — without bloat, without ceremony, and without a multi-month onboarding curve.

## 2. The problem we're solving

Today, small business accountants typically rely on a patchwork of tools that were not designed for them: spreadsheets, generic SaaS, ad-hoc workflows. The result is wasted time, brittle process, and decisions made without good data.
...
A web app that does the daily core action in one place, gives small business accountants an at-a-glance picture of the things they actually care about, and is exportable / portable by default. Opinionated where opinions help, configurable where they must be.
...
- What is the single most important "daily core action" for small business accountants?
