# MASTERPLAN — Website System for Small Local Businesses

> Single source of truth. If anything in the repo contradicts this file, this file wins.

## 1. Vision

A focused website that helps **small local businesses** solve a specific, painful problem in **small business** — without bloat, without ceremony, and without a multi-month onboarding curve.

## 2. The problem we're solving

Today, small local businesses typically rely on a patchwork of tools that were not designed for them: spreadsheets, generic SaaS, ad-hoc workflows. The result is wasted time, brittle process, and decisions made without good data.
...
A website that does the daily core action in one place, gives small local businesses an at-a-glance picture of the things they actually care about, and is exportable / portable by default. Opinionated where opinions help, configurable where they must be.
...
- What is the single most important "daily core action" for small local businesses?
