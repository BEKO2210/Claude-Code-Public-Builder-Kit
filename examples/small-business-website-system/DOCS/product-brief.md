# Product brief — Website System for Small Local Businesses
...
A small local businesses owner / operator who is currently working in **small business**, has tried at least one existing tool, and is willing to switch if a better one shows up.

## 2. Jobs to be done

When small local businesses hire a tool like this, they are usually trying to:
