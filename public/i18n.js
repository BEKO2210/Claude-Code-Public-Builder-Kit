...
const STRINGS = {
  en: {
    ...
    "result.step3.title": "Attach all 12 files and paste this prompt",
    "result.step3.body.html": "Open the ZIP. In Claude, click the paperclip <span class=\"ico-clip\" aria-hidden=\"true\">📎</span> below the chat and select <strong>all 12 files</strong> from the unzipped folder (or hold Ctrl/Cmd and click each one). If your plan has an upload limit, at minimum attach <code>MASTERPLAN.md</code>, <code>ROADMAP.md</code> and <code>ARCHITECTURE.md</code>. Then paste this:",
    "result.step3.copy": "Copy prompt",
    "result.step3.copied": "Copied!",
    "result.step3.copy-failed": "Copy failed",

    "alt.summary": "Other ways to use your kit",
    "alt.hint": "If you want a backup on GitHub or you're comfortable with a terminal.",
    "alt.github.title": "Save it to GitHub (free, beginner-friendly)",
    "alt.github.body": "Best if you want a backup, want to come back to the plan later, or want to share it with someone. Takes about 3 minutes the first time.",
    "alt.github.s1": "Go to <a href=\"https://github.com/signup\" target=\"_blank\" rel=\"noopener noreferrer\">github.com/signup</a> and create a free account (just email + password).",
    "alt.github.s2": "Once logged in, click the <strong>+</strong> top-right and choose <strong>New repository</strong>. Pick any name (e.g. <code>my-kit</code>), choose <strong>Public</strong>, leave the rest as default, click <strong>Create repository</strong>.",
    "alt.github.s3": "On the new empty page, click the link <strong>uploading an existing file</strong>.",
    "alt.github.s4": "Open the ZIP you downloaded. Drag <em>all the files</em> from inside it onto the GitHub upload page. Wait until they appear in the list.",
    "alt.github.s5": "Scroll down and click the green <strong>Commit changes</strong> button. Done — your kit is online.",
    "alt.github.s6.html": "Now go back to <a href=\"https://claude.ai/new\" target=\"_blank\" rel=\"noopener noreferrer\">claude.ai</a> and paste this in your chat:",
    "alt.github.prompt": "I have a project plan in a GitHub repo. Please read all 12 markdown files at {URL} (replace this with your repo URL — copy it from your browser address bar). Summarise the masterplan back to me, then walk me through Phase 1 / Step 1 in plain language. Ask me one question at a time.",
    "alt.github.copy": "Copy this prompt",
    "alt.terminal.title": "Use Claude Code in your terminal (for developers)",
    "alt.terminal.body": "If you have Node.js installed and are comfortable in a shell, this is the most powerful way — Claude reads every file in the folder and can edit them directly.",
  ...
  de: {
    ...
    "result.step3.title": "Alle 12 Dateien anhängen und diesen Text einfügen",
    "result.step3.body.html": "ZIP entpacken. In Claude unten links auf das Büroklammer-Symbol <span class=\"ico-clip\" aria-hidden=\"true\">📎</span> klicken und <strong>alle 12 Dateien</strong> aus dem entpackten Ordner auswählen (oder mit Strg/Cmd jede einzeln anklicken). Falls dein Plan ein Upload-Limit hat, mindestens <code>MASTERPLAN.md</code>, <code>ROADMAP.md</code> und <code>ARCHITECTURE.md</code> anhängen. Dann diesen Text einfügen:",
    "result.step3.copy": "Text kopieren",
    "result.step3.copied": "Kopiert!",
    "result.step3.copy-failed": "Kopieren fehlgeschlagen",

    "alt.summary": "Andere Wege, dein Kit zu benutzen",
    "alt.hint": "Wenn du eine Sicherung auf GitHub willst oder dich mit dem Terminal auskennst.",
    "alt.github.title": "Auf GitHub sichern (kostenlos, anfängerfreundlich)",
    "alt.github.body": "Am besten, wenn du eine Sicherung willst, später zurück zum Plan möchtest oder ihn mit jemandem teilen willst. Beim ersten Mal dauert das etwa 3 Minuten.",
    "alt.github.s1": "Geh auf <a href=\"https://github.com/signup\" target=\"_blank\" rel=\"noopener noreferrer\">github.com/signup</a> und erstell dir einen kostenlosen Account (nur E-Mail + Passwort).",
    "alt.github.s2": "Nach dem Login oben rechts auf das <strong>+</strong> klicken und <strong>New repository</strong> wählen. Beliebigen Namen vergeben (z.B. <code>mein-kit</code>), <strong>Public</strong> auswählen, Rest auf Standard lassen, auf <strong>Create repository</strong> klicken.",
    "alt.github.s3": "Auf der leeren Repository-Seite den Link <strong>uploading an existing file</strong> anklicken.",
    "alt.github.s4": "ZIP entpacken. <em>Alle Dateien</em> aus dem entpackten Ordner auf die GitHub-Upload-Seite ziehen. Warten bis sie in der Liste erscheinen.",
    "alt.github.s5": "Nach unten scrollen und auf den grünen Button <strong>Commit changes</strong> klicken. Fertig — dein Kit ist online.",
    "alt.github.s6.html": "Jetzt zurück auf <a href=\"https://claude.ai/new\" target=\"_blank\" rel=\"noopener noreferrer\">claude.ai</a> und diesen Text in den Chat einfügen:",
    "alt.github.prompt": "Ich habe einen Projektplan in einem GitHub-Repo. Bitte lies alle 12 Markdown-Dateien unter {URL} (ersetze das durch deine Repo-URL — kopier sie aus der Adresszeile deines Browsers). Fasse den Masterplan in eigenen Worten zusammen und führ mich dann in einfacher Sprache durch Phase 1 / Schritt 1. Stell mir bitte eine Frage nach der anderen.",
    "alt.github.copy": "Diesen Text kopieren",
    "alt.terminal.title": "Claude Code im Terminal benutzen (für Entwickler)",
    "alt.terminal.body": "Wenn du Node.js installiert hast und dich mit einer Shell auskennst, ist das der mächtigste Weg — Claude liest jede Datei im Ordner und kann sie direkt bearbeiten.",
