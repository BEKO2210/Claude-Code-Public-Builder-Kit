...
1. **Domain depth: tenth domain (crosses 50% coverage).** Nine domains now specialised (`climate & sustainability`, `professional services`, `health & wellness`, `finance`, `food & hospitality`, `education`, `logistics & supply chain`, `retail & e-commerce`, `creative & media`). Best next candidates: **`real estate`** (fair-housing under FHA + EU equivalents, MLS / IDX integration patchwork, dual-agent disclosure, jurisdictional patchwork on rental + tenancy + listing accuracy + agency licensing, anti-money-laundering on high-value transactions), or **`non-profit & community`** (501(c)(3) / charity-commission compliance, donor-data privacy, restricted-fund accounting, mission-vs-platform trust, low-budget operational reality, volunteer-vs-staff data handling). Real estate edges ahead on regulatory density and breadth of likely user-base relevance.
