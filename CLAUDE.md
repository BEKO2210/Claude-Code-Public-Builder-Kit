...
1. **Domain depth: eleventh domain.** Ten domains now specialised (`climate & sustainability`, `professional services`, `health & wellness`, `finance`, `food & hospitality`, `education`, `logistics & supply chain`, `retail & e-commerce`, `creative & media`, `real estate`). Best next candidates: **`non-profit & community`** (501(c)(3) / charity-commission compliance, donor-data privacy, restricted-fund accounting, mission-vs-platform trust, low-budget operational reality, volunteer-vs-staff data handling), or **`government & civic`** (FOIA / public-records, accessibility-by-statute, procurement, constituent-data privacy, election-system separateness). Non-profit & community edges ahead because it directly matches a frequent builder-kit idea pattern (volunteer / donor / mission products) where a generic "professional services" specialisation underserves the user.
